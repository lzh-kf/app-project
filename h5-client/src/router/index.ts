  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'category', name: 'Category', component: () => import('@/pages/category/index.vue'), meta: { title: '分类' } },
        { path: 'cart', name: 'Cart', component: () => import('@/pages/cart/index.vue'), meta: { title: '购物车', requiresAuth: true } },
        { path: 'profile', name: 'Profile', component: () => import('@/pages/profile/index.vue'), meta: { title: '我的', requiresAuth: true } },
      ],
    },
